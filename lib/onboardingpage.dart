              ...
              child: Column(
                children: [
                  ...
                  Container(
                      ...
                      child: const Text("Stop into strength and confidence\n Your fitness journey starts here...",style: TextStyle(color: Colors.white,fontSize: 25))
                  ),
                ],
              ),
            ),
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                      margin: const EdgeInsets.only(top: 20),
                      child: const Text(" Transform your body and mind \n   step into a healthier stronger\n        you with every workout.",style: TextStyle(color: Colors.white,fontSize: 25))
                  ),
                ],
              ),
            ),
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                      margin: const EdgeInsets.only(top: 20),
                      child: const Text("  Sweat, smile, and repeat build the body \n                you’ve always dreamed of.....",style: TextStyle(color: Colors.white,fontSize: 20))
                  ),
                  Container(
                      margin: const EdgeInsets.only(top: 40),
                      width: 350,
                      ...
                      }, child: const Text("GET STARTED",style: TextStyle(color: Colors.white,fontSize: 30),))
                  )
        ...
        child: Row(
          ...
          children: [
            ...
            TextButton(onPressed: ()=>controller.nextPage(
                duration: Duration(milliseconds: 500), curve: Curves.easeInOut), child:Text("NEXT",style: TextStyle(color: Colors.white),)),
